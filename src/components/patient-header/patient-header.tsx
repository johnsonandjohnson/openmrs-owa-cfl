...
import { getPatient } from '../../redux/reducers/patient.reducer';
import { getPerson } from '../../redux/reducers/person.reducer';
import { getPatientHeaderFieldValue } from './patient-header-util';
import './patient-header.scss';
import { searchLocations } from 'src/redux/reducers/location';
...
const mapStateToProps = ({ patient, person, location }: any) => ({

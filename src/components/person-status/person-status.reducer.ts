...
export const putPersonStatus = (patientUuid: string, personStatus: PersonStatusUI, intl: any) => async (dispatch) => {
    const body = {
        type: ACTION_TYPES.PUT_PERSON_STATUS,
        payload: axiosInstance.put(personStatusUrl + patientUuid, personStatus.toModel())
    };

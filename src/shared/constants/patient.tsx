...
export const PATIENT_TABLE_COLUMNS = FIND_PATIENT_TABLE_COLUMNS.split(",");

export const FIND_CAREGIVER_TABLE_COLUMNS =
  process.env.REACT_APP_FIND_CAREGIVER_TABLE_COLUMNS ||
  `${PERSON_IDENTIFIER},${FAMILY_NAME},${GIVEN_NAME},${GENDER},${AGE},${BIRTHDATE}`;
export const CAREGIVER_TABLE_COLUMNS = FIND_CAREGIVER_TABLE_COLUMNS.split(",");
